...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.voorraad AS voorraad, products.verzendkosten AS verzendkosten FROM products ORDER BY id ASC')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.voorraad AS voorraad, products.verzendkosten AS verzendkosten FROM products WHERE id = ?')
